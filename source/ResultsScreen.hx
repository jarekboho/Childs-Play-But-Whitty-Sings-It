...
class ResultsScreen extends FlxSubState
{
	...
	override function update(elapsed:Float)
	{
		...
		if (PlayerSettings.player1.controls.ACCEPT)
		{
			...
			#if !switch
			Highscore.saveScore(PlayState.SONG.songId, Math.round(PlayState.instance.songScore), 2);
			Highscore.saveCombo(PlayState.SONG.songId, Ratings.GenerateLetterRank(PlayState.instance.accuracy), 2);
			#end
